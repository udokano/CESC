...
<header class="l-header p-header">
  <div class="l-header-container u-flex-sb u-align-cent">
	...
	<div class="p-header-btns">
		<a href="<?php echo home_url( '/' ); ?>reserve/kanto.html" class="c-btn-cal p-btn-cal-pages" target="_blank"> <span class="u-pc-only">カウンセリング予約</span> <span class="u-sp-only">WEB予約</span> </a>
