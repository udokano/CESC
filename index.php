...
<section class="l-section p-doctor" id="link-doctor">
  <div class="l-doctor-inner">
    ...
    <div class="l-inner">
      ...
      <div class="p-doctor-cal"> <?php echo do_shortcode('[xo_event_calendar months="2" holidays="ope" navigation="false"]'); ?> </div>
      <!-- ./p-doctor-cal -->
    </div>
    <!-- ./l-inner -->
  </div>
...
<section class="l-section p-access" id="link-access">
  <div class="l-inner p-access__inner">
    ...
    <ul class="p-access-thumbs">
      <li class="p-access-thumbs__item js-modal-open" data-target="js-modal-01"> <img src="<?php echo get_template_directory_uri(); ?>/src/img/top/access_thumb01.jpg" alt="アクセスサムネイル画像"> <i class="p-access-thumbs__icon"> <img src="<?php echo get_template_directory_uri(); ?>/src/img/top/access_thumb_icon01.png" alt="アイコン"> </i> </li>
      <li class="p-access-thumbs__item js-modal-open"   data-target="js-modal-02"> <img src="<?php echo get_template_directory_uri(); ?>/src/img/top/access_thumb02.jpg" alt="アクセスサムネイル画像"> <i class="p-access-thumbs__icon"> <img src="<?php echo get_template_directory_uri(); ?>/src/img/top/access_thumb_icon01.png" alt="アイコン"> </i> </li>
      <li class="p-access-thumbs__item js-modal-open" data-target="js-modal-03"> <img src="<?php echo get_template_directory_uri(); ?>/src/img/top/access_thumb03.jpg?0614" alt="アクセスサムネイル画像"> <i class="p-access-thumbs__icon"> <img src="<?php echo get_template_directory_uri(); ?>/src/img/top/access_thumb_icon02.png" alt="アイコン"> </i> </li>
      <li class="p-access-thumbs__item js-modal-open" data-target="js-modal-04"> <img src="<?php echo get_template_directory_uri(); ?>/src/img/top/access_thumb04.jpg?0610" alt="アクセスサムネイル画像"> <i class="p-access-thumbs__icon"> <img src="<?php echo get_template_directory_uri(); ?>/src/img/top/access_thumb_icon02.png" alt="アイコン"> </i> </li>
    </ul>
    <!-- modal  content01 -->
